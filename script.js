    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "טבע קלאב - מועדון המטפלים הישראלי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '281f29c9-e598-4b4d-961e-e1addd755bc4',
                    name: data.name || '',
                    email: data.email || '',
